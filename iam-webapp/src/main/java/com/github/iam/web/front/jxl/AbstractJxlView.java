 ...
 * @see AbstractPdfView
 * 
 * @see http://stackoverflow.com/questions/19663387/cant-get-proper-encoding-for-jexcel-jxl
 */
public abstract class AbstractJxlView extends AbstractView {
    
    protected static final Logger LOGGER = LoggerFactory.getLogger(AbstractJxlView.class);
